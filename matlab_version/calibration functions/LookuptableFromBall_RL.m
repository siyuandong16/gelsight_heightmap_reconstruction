function [gradmag, graddir, countmap]=LookuptableFromBall_RL(dI,f0, bins, center, BallRad, Pixmm, validmask,gradmag, graddir, countmap, zeropoint, lookscale, f01)
...
r1=dI(validid)./f0(validid)./f01(validid);
g1=dI(validid+sizet)./f0(validid+sizet)./f01(validid);
b1=dI(validid+sizet2)./f0(validid+sizet2)./f01(validid);r2=(r1-zeropoint)/lookscale;r2(r2<0)=0;r2(r2>1)=1;
